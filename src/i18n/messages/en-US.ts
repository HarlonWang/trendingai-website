...
export const enUS: SiteMessages = {
    ...
    trending: {
        ...
        sidebarHint: "Showing the last 14 days of snapshots. Each date has AM and PM captures. Switch between Daily, Weekly, and Monthly trending on the right.",
        todayLabel: "Today",
        batchAm: "AM",
        batchPm: "PM",
        loading: "Loading trending data...",
        empty: "No trending data available for this selection.",
        ...
        periodStarsMonthly: "Stars (This Month)",
        sinceDaily: "Daily",
        sinceWeekly: "Weekly",
