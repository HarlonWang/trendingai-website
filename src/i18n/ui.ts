...
const en = {
    ...
    "pay.title": "Checkout - Trending AI",
    "pay.description": "Complete your Trending AI Pro subscription",
    "pay.opening": "Opening secure checkout\u2026",
    "pay.openingHint": "Powered by Paddle. If the checkout doesn't appear, refresh this page.",
    "pay.missing": "This page needs to be opened from the subscribe button in the app.",
    "pay.failed": "Failed to load the checkout. Please check your network and refresh.",
    "pay.backHome": "Back to home",
    "paySuccess.title": "Payment Successful - Trending AI",
    "paySuccess.description": "Your Trending AI Pro subscription is active",
    "paySuccess.heading": "Payment successful",
    "paySuccess.body": "Your Pro subscription is now active. Go back to the app and pull to refresh \u2014 your Pro benefits will show up right away.",
    "paySuccess.note": "A receipt has been sent to your email by Paddle, our payment partner.",
...
const zh: Record<UIKey, string> = {
    ...
    "pay.title": "支付 - Trending AI",
    "pay.description": "完成 Trending AI Pro 订阅支付",
    "pay.opening": "正在打开安全收银台\u2026",
    "pay.openingHint": "支付由 Paddle 提供。若收银台未弹出，请刷新本页。",
    "pay.missing": "请从 App 内的订阅按钮进入本页面。",
    "pay.failed": "收银台加载失败，请检查网络后刷新重试。",
    "pay.backHome": "返回首页",
    "paySuccess.title": "支付成功 - Trending AI",
    "paySuccess.description": "你的 Trending AI Pro 已生效",
    "paySuccess.heading": "支付成功",
    "paySuccess.body": "Pro 订阅已生效。回到 App 下拉刷新，即可立即看到 Pro 权益。",
    "paySuccess.note": "收据已由支付服务商 Paddle 发送至你的邮箱。",
